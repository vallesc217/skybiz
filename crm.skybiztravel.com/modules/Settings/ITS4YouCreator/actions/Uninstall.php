...
class Settings_ITS4YouCreator_Uninstall_Action extends Settings_Vtiger_Basic_Action
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        /** @var $moduleModel ITS4YouCreator_Module_Model */
        $moduleModel = Vtiger_Module_Model::getInstance($moduleName);
        $result = array('success' => false);

        if ($moduleModel) {
            $moduleModel->delete();
            $moduleModel->disableCreatorFields();
