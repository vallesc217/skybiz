...
{strip}
	<style>
		body {
			background: url(layouts/v7/resources/Images/new_20945934-min.jpg);
	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-4 col-lg-offset-4" col-xs-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/Logo_new_sky.png">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #15c;">olvido su password?</a>
						</div>
					</form>
				</div>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						<div class="group">
							<input id="fusername" type="text" name="username" placeholder="Nombre de Usuario" >
							<span class="bar"></span>
							<label>Nombre de Usuario</label>
						</div>
						<div class="group">
